// Bundled by hand from src/lib/mcp/index.ts (no longer auto-regenerated by the Lovable Vite plugin).
// If you change src/lib/mcp/**, re-run the bundle step manually and update this file to match.
