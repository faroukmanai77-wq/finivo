...
const BrokerageComparator = () => {
  ...
  const breadcrumbs = [
    ...
    { name: 'Plateformes de courtage', url: 'https://finivo.ca/comparateurs/courtage' },
  ];

  const categories = [
    { id: 'zero-commission', label: 'Zéro commission', icon: '💰' },
    { id: 'debutant', label: 'Débutant', icon: '🎓' },
    { id: 'avance', label: 'Avancé', icon: '📈' },
    { id: 'comptes-enregistres', label: 'CELI / REER', icon: '🏦' },
    { id: 'crypto', label: 'Crypto', icon: '₿' },
    { id: 'quebec-friendly', label: 'Québec friendly', icon: '🍁' },
  ];

  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Comparateur de Plateformes de Courtage au Canada 2025 | Finivo" 
        description="Comparez les meilleures plateformes de courtage en ligne au Canada. Wealthsimple, Questrade, IBKR, Disnat et plus. Trouvez le courtier idéal pour investir: CELI, REER, ETF, actions, options." 
        keywords="comparateur courtage, meilleur courtier Canada, plateforme investissement Québec, Wealthsimple Trade, Questrade, IBKR, courtier en ligne, CELI, REER" 
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <Select
                    ...
                    onValueChange={(value: 'rating' | 'fees' | 'name') => setFilters({ ...filters, sortBy: value })}
                  >
