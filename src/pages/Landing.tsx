...
const Landing = () => {
  ...
  const calculators = [
    { icon: TrendingUp, name: 'Intérêts composés', href: '/calculateurs/interets-composes' },
    { icon: PiggyBank, name: 'Épargne REER', href: '/calculateurs/reer' },
    { icon: PiggyBank, name: 'Épargne CELIAPP', href: '/calculateurs/celiapp' },
    { icon: Scale, name: 'Valeur nette', href: '/calculateurs/valeur-nette' },
    { icon: Receipt, name: 'Consolidation de dettes', href: '/calculateurs/consolidation-dettes' },
    { icon: Receipt, name: 'Impôt Canada/Québec', href: '/calculateurs/impot' },
  ];
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              <Button 
                ...
                variant="outline" 
                size="lg" 
                className="h-14 px-8 bg-secondary-foreground/10 border-secondary-foreground/20 text-secondary-foreground hover:bg-secondary-foreground/20 font-semibold gap-3 text-lg"
              >
