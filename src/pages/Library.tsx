...
const Library = () => {
  ...
  const categories: { id: BookCategory; label: string; icon: string }[] = [
    { id: 'finance-personnelle', label: 'Finance personnelle', icon: '💰' },
    { id: 'investissement', label: 'Investissement', icon: '📈' },
    { id: 'liberte-financiere', label: 'Liberté financière', icon: '🆓' },
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Bibliothèque Finance & Liberté Financière | Finivo" 
        description="Découvrez les meilleurs livres pour améliorer votre relation à l'argent, investir intelligemment et bâtir votre liberté financière. Sélection de livres en français et en anglais." 
        keywords="livres finance personnelle, livres investissement, liberté financière, meilleurs livres argent, livres budget, livres REER CELI" 
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                ...
                <Select
                  ...
                  onValueChange={(value: 'popularity' | 'beginner' | 'recommended' | 'title') => 
