...
('Carte CobaltMD American Express', 'American Express', 155.88, false, 20.99, 21.99, 5, 'points', 'Jusqu''à 30 000 points privilèges', 300, NULL, ARRAY['5 points par 1$ (Épicerie et Resto)', '2 points par 1$ (Voyages)', '1 point par 1$ (Reste)', 'Assurance voyage'], ARRAY['travel', 'premium', 'rewards'], 'https://example.com/amex-cobalt', 4.9),
('Carte World Elite Mastercard BNC', 'Banque Nationale', 150, true, 20.99, 22.99, 2, 'points', 'Jusqu''à 35 000 points', 350, 80000, ARRAY['Accès Salon BNC', '150$ remboursement voyage', 'Assurance médicale', 'Assurance annulation'], ARRAY['travel', 'premium', 'rewards'], 'https://example.com/bnc-world-elite', 4.7),
('Mastercard Simplii Financial', 'Simplii', 0, false, 19.99, 22.99, 4, 'cashback', '10% de remise les 4 premiers mois', 200, NULL, ARRAY['4% dans les restaurants', '1.5% essence et épicerie', 'Aucun frais annuel', 'Simple et rapide'], ARRAY['cashback', 'no-fee'], 'https://example.com/simplii', 4.5);
